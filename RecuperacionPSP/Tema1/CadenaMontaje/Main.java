...
public class Main extends JFrame implements WindowListener {
	...
	private Cadena cadena = new Cadena(800);
	private Colocador colocador = new Colocador(cadena);
	private Empaquetador empa1 = new Empaquetador(Productos.Uno, cadena);
	private Empaquetador empa2 = new Empaquetador(Productos.Dos, cadena);
	private Empaquetador empa3 = new Empaquetador(Productos.Tres, cadena);
